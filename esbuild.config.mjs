...
// 1. Module
await build({ bundle: true, entryPoints: ['packages/alpine/dist/bundler.mjs'], format: 'esm', outfile: './dist/ui.mjs' });
outputSize('./dist/ui.mjs');

// 2. CDN
await build({ bundle: true, entryPoints: ['packages/alpine/dist/bundler.mjs'], outfile: './dist/ui.js' });
outputSize('./dist/ui.js');

// 3. Minified CDN
await build({ bundle: true, entryPoints: ['packages/alpine/dist/bundler.mjs'], minify: true, outfile: './dist/ui.min.js' });
