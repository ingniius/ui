...
@php
    $self = Vee\UI::tv(['extend' => Vee\Theme\UI::avatar(), ...uComponent('avatar')])(['size' => $size]);
...
<x-button-or-link :$as :$href :attributes="$attributes->class($self->root($rootClass))" data-ui-avatar>
    @if ($src)
