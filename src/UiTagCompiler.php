...
final class UiTagCompiler extends ComponentTagCompiler
{
    public function componentString(string $component, array $attributes)
    {
        ...
        if ($component === 'vee::delegate-component') {
            ...
            return "<?php if (!Ui::componentExists(\$name = {$component})) throw new \Exception(\"Ui component [{\$name}] does not exist.\"); ?>##BEGIN-COMPONENT-CLASS##@component('{$class}', 'vee::' . {$component}, [
    'view' => (app()->version() >= 12 ? hash('xxh128', 'vee') : md5('vee')) . '::' . {$component},
...
<?php \$component->withAttributes(\$attributes->getAttributes()); ?>";
    ...
    protected function compileOpeningTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            return $this->componentString("vee::{$matches[1]}", $attributes);
        }, $value);
    }
    ...
    protected function compileSelfClosingTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            if (isset($attributes['slot'])) {
                ...
                return '@slot('.$slot.') '.$this->componentString("vee::{$matches[1]}", $attributes)."\n@endComponentClass##END-COMPONENT-CLASS##".' @endslot';
            }
    ...
    {
        return preg_replace("/<\/\s*vee[\:][\w\-\:\.]*\s*>/", ' @endComponentClass##END-COMPONENT-CLASS##', $value);
    }
}
