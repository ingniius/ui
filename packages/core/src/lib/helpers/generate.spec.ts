...
describe("#generateCSS", () => {
  it("should include @source lines for each source", () => {
  ...
  it("should always include neutral shades", () => {
  ...
  it("should generate custom color variables when theme.colors is provided", () => {
    const css = generateCSS({
      sources: [],
  ...
  it("should always include text, background, border, radius variables", () => {
    const css = generateCSS({ sources: [], theme: defaultTheme });
