...
// 1. Module
await build({ bundle: true, entryPoints: ["src/index.mjs"], format: "esm", outfile: "../../dist/ui.mjs" });
outputSize("../../dist/ui.mjs");

await build({ bundle: true, entryPoints: ["src/index.mjs"], format: "esm", outfile: "dist/index.mjs" });
outputSize("dist/index.mjs");

// 2. CDN
await build({ bundle: true, entryPoints: ["src/index.mjs"], outfile: "../../dist/ui.cjs" });
outputSize("../../dist/ui.cjs");

await build({ bundle: true, entryPoints: ["src/index.mjs"], outfile: "dist/index.cjs" });
outputSize("dist/index.cjs");

// 3. Minified CDN
await build({ bundle: true, entryPoints: ["src/index.mjs"], minify: true, outfile: "../../dist/ui.min.js" });
