...
describe("#Primitive", () => {
  ...
  it("should render button element correctly", () => {
    const wrapper = mount(Primitive, { props: { as: "button" } });
  ...
  it("should renders div element with custom attribute", () => {
    const wrapper = mount(Primitive, { attrs: { type: "button" } });
    const element = wrapper.find("div");
  ...
  it("should render as template (asChild)", () => {
    const wrapper = () =>
      mount(Primitive, {
        props: { asChild: true },
        slots: { default: "<div>1</div><div>2</div><div>3</div>" },
  ...
  it("should pass custom attribute to first element", () => {
    const wrapper = mount(Primitive, {
      props: { asChild: true, type: "button" },
      slots: { default: "<div>1</div><div>2</div><div>3</div>" },
    });
  ...
  it("should merge child's class together", () => {
    const wrapper = mount(Primitive, {
      ...
      slots: {
        default: "<div class=\"child-class more-child-class\">Child class</div>",
      },
    });
  ...
  it("should render the child component", () => {
    const ChildComponent = { template: "<div id=\"child\">Hello world</div>" };
    const RootComponent = {
      components: { ChildComponent, Primitive },
      template: "<Primitive><ChildComponent /></Primitive>",
    };

    const wrapper = mount(RootComponent, { props: { asChild: true } });
    const element = wrapper.find("div");
  ...
  it("should inherit parent attributes and the child attributes", () => {
    const wrapper = mount(Primitive, {
      props: { asChild: true },
      attrs: { "data-parent-attr": "" },
      slots: { default: "<div data-child-attr>Child class</div>" },
    });
  ...
  it("should replace parent attributes with child's attributes", () => {
    const wrapper = mount(Primitive, {
      props: { asChild: true },
      attrs: { "id": "parent", "data-type": "button" },
      slots: {
  ...
  it("'as=template' should work the same as 'asChild=true'", () => {
    const wrapper = mount(Primitive, {
      props: { as: "template" },
      attrs: { class: "parent-class" },
      slots: { default: "<button class=\"child-class\">Child element</button>" },
    });
